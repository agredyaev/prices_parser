...
class TestDriver(unittest.TestCase):
    ...
    def test_running_driver_with_options(self):
        with Driver(options='suwgih') as driver:
            driver.load_url(Config.TEST_URL, wait_for_page_body=True)
            selector_start_page = """
                //*[@class="b-button b-button_disabled_false 
                b-button_theme_catchy b-button_shape_default b-button_size_l 
                b-button_justify_center b-button_selected_false 
                p-index__banner-link"]
            """
